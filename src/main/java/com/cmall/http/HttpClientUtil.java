...
public class HttpClientUtil {
	 ...
	 * @return
	 */
	public static CloseableHttpResponse doPost(String url, Map<String, String> paramsMap,
	 ...
	 * @return
	 */
	public static CloseableHttpResponse doPut(String url, Map<String, String> paramsMap, CloseableHttpClient httpclient,
			CookieStore cookieStore) {
	 ...
	 * @return
	 */
	public static CloseableHttpResponse doDelete(String url, Map<String, String> paramsMap,
			CloseableHttpClient httpclient, CookieStore cookieStore) {
