 ...
 *
 */
public class Driver2_tmp {

	private  AndroidDriver<WebElement> mdriver;

	public  AndroidDriver<WebElement> newInstance() {

		if (mdriver == null) {
			PropertyUtil pro = new PropertyUtil("/app.properties"); // 这里需要加个/表示类的根目录,从配置中取数据
			String udid1 = pro.getValue("deviceName_redmi");
			String udid2 = pro.getValue("deviceName_meizu");
...
//			initAndroidDriver(udid1,udid1,"4723", appPackage, appActivity);
			initAndroidDriver(udid2,udid2,"4723", appPackage, appActivity);
		}
		return mdriver;
	}

	private  void initAndroidDriver(String deviceName,String udid,String port, String appPackage, String appActivity) {
